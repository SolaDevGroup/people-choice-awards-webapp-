...
function lbRowHTML(p,rank){
  ...
  const rankEl = rank<=4
    ? `<span class="lb-rank lb-rank-badge"><img src="assets/leader${rank}.png?v=20260628bi" alt="${rank}"></span>`
...
function renderLeaderboard(){
  const lg=document.getElementById('lbLogo');if(lg&&!lg.getAttribute('src'))lg.src='assets/word_logo.svg?v=20260628bi';
